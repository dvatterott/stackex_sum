...
class acquire_SE_info:
    ...
    def fetch_and_clean(self,text,model_prep=True):
...
#for i,question in enumerate(so.questions(tagged=['python','numpy'], pagesize=100,sort=stackexchange.Sort.Creation, stackexchange.order=DESC)): #http://stackoverflow.com/questions/tagged/python+numpy just under 29k responses...
