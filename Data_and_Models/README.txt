...
This mdoel uses a bag of words input with tfidf the objects that will perform count vectorization and tfidf are also in this folder (count_vec.pkl and tfidf_tansformer.pkl)
...
I am updating the new database though. Im just going to let it hit the stackoverflow system until i get all of them.
